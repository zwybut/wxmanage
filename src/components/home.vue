  ...
  <div style="height:100%;">
    ...
    <el-menu
		  ...
		  <el-menu-item index="4"><router-link to="/FloodReportSearch">原报文查询</router-link></el-menu-item>
			<el-menu-item index="6" v-if="distribute_show"><router-link to="/DistributeManage">分发管理</router-link></el-menu-item>
		  ...
		  <el-menu-item index="8"><router-link to="/UserManage">管理员信息管理</router-link></el-menu-item>
			<el-menu-item index="9" v-if="distribute_show"><router-link to="/MenuManage">公众号菜单配置</router-link></el-menu-item>
		</el-menu>
...
export default {
  ...
  methods: {
    ...
    getStorage () {										//获取sessionStorage中的用户名
      let sStorage = window.sessionStorage
	  if (sStorage['loginName']) {							//存在，将store中的show置为true
		console.log(sStorage['loginName'])
	   if(sStorage['loginName'] != '330000'){
			console.log(1111111111)
			this.distribute_show = false
		}else{
			console.log(222222222222)
			this.distribute_show = true
		}
